    ...
    <div class="container p-camera">
        <div class="row nav-sub">
            <ul>
                ...
                <li><a href="<?php echo URL_ROOT;?>/camera-dahua" class = "li-active">Camera HIKVISION</a></li>  
            </ul>
        </div>
        <div class="row">
            <div class="col-md-9 sp-left">
                <div class="linkien_title row" >
                    <p class = "" >Camera IP HIKVISION</p>
                </div>
                <div class="row list-product">
                    ...
                    <?php
                        ...
                        $args = array(
	                        ...
	                        'meta_value'	=> 'camera-ip-hikvision',
                            'posts_per_page' => '20',
                            'paged' => $paged
                        );
                        $tmp_print = 0;
                ...
                <div class="row list-product">
                    ...
                    <?php
                        ...
                        $args = array(
                            ...
                            'post_status' => 'publish',
                            'meta_key'		=> 'type_camera',
	                        'meta_value'	=> 'dau-ghi-hikvision',
                            'posts_per_page' => '20',
                            'paged' => $paged
                        );
                        $tmp_print = 0;
                        $products_loop_dg = new WP_Query( $args );
                        if ( $products_loop_dg->have_posts() ) :
                            while ( $products_loop_dg->have_posts() ) : $products_loop_dg->the_post();
                            // Set variables
                                $tmp_print = 1;
                                $title = get_the_title();
                                $link_lk = get_the_permalink();
                ...
                <div class="row pagination-list">
                    <?php if (function_exists('devvn_wp_corenavi')) devvn_wp_corenavi($products_loop_dg);?>
                </div>
