    ...
    <div class="container p-camera">
        <div class="row nav-sub">
            <ul>
                ...
                <li><a href="<?php echo URL_ROOT;?>/camera-dahua" class = "li-active">Camera DAHUA</a></li>  
            </ul>
        </div>
        <div class="row">
            <div class="col-md-9 sp-left">
                <div class="linkien_title row" >
                    <p class = "" >Camera IP DAHUA</p>
                </div>
