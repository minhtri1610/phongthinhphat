    ...
    <div class="container p-camera">
        <div class="row nav-sub">
            <ul>
                ...
                <li><a href="<?php echo URL_ROOT;?>/camera-quan-sat/camera-hikvison">Camera HIKVISION</a> &#8811;</li>
                <li><a href="<?php echo URL_ROOT;?>/camera-quan-sat/camera-hikvison/camera-ip-hikvision" class = "li-active">Camera IP HIKVISION</a></li>   
            </ul>
        </div>
        <div class="row">
